...
class product_category_controller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.showproduct_category',compact('pro_cat'));
    ...
    public function create()
    {
        ...
        $pro=product::all();
        $cat=category::all();
        return view('admin.product_category',compact('cat','pro'));
    ...
    public function edit($id)
    {
        ...
        return view('admin.editproduct_category',compact('pro_cat')); 
    }
